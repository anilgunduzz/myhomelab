...
| 💻&nbsp;[`workstation/`](./workstation) | 🚧&nbsp;In&nbsp;progress | CachyOS + KDE daily driver: why each component was chosen, and the open items (Secure Boot, snapshot automation) still to be closed. |
